...
if __name__ == '__main__':
    ...
    for dir_name in dir_names:
        ...
        for file_name in file_names:
            f = open(
                path_data + dir_name + "/" + file_name, encoding="gb18030", errors="ignore"
            )
            content = f.read()
            f.close()
    ...
    accuracy = train_model(
        naive_bayes.MultinomialNB(), xtrain_tfidf_ngram, train_y, xvalid_tfidf_ngram
    )
    ...
    accuracy = train_model(
        linear_model.LogisticRegression(), xtrain_tfidf_ngram, train_y, xvalid_tfidf_ngram
    )
    ...
    accuracy = train_model(
        classifier, xtrain_tfidf_ngram, train_y, xvalid_tfidf_ngram, is_neural_net=True
    )
